function Footer() {
  return (
    <>
      <img src="src/assets/images/footer.svg" alt="Bannière décorative" />

      <div className="bg-theme1-900 relative">
        <div className="max-w-screen-md mx-auto px-4 py-8">
          <div className="md:flex items-center justify-between">
            <img src="src/assets/images/download.jpg" alt="Couverture du livre de recettes" className="w-full md:w-1/3 mb-4 md:mb-0 md:mr-8" />
            <div className="text-white md:w-2/3">
              <h2 className="text-2xl font-bold mb-4">Téléchargez Notre Livre de Recettes Gratuit !</h2>
              ...
              <button type="button" className="bg-white text-red-500 px-4 py-2 rounded-md w-full">Télécharger Maintenant</button>
            </div>
          </div>
        </div>
      </div>

      <div className="bg-theme1-950 text-white text-center py-2 w-full">
